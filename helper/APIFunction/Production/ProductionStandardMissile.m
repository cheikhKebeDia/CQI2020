function [missileHit, gameEnd] = ProductionStandardMissile(token, uri, gamesId, column, row)
    uri = uri + "/tournaments/rounds/games/"+gamesId;

    contentTypeField = matlab.net.http.field.ContentTypeField('application/json');
    data = struct("missileType", "standard", "parameters",struct("column", column, "row", row));
    ...
    missileHit = decodedResponse.missileHit;
    gameEnd = decodedResponse.gameEnd;
end
